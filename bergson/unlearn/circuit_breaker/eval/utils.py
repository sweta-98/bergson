...
def init_rep_control(
    ...
    from repe import WrappedReadingVecModel, repe_pipeline_registry
    ...
    for layer in layer_id:
        activations[layer] = (
            torch.tensor(
                repe_coeff
                * rep_reader.directions[layer][component_index]
                * rep_reader.direction_signs[layer][component_index]
            )
            .to(model.device)
            .half()
        )

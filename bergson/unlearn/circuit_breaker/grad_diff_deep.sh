...
# Gradient Difference Unlearning for Deep Ignorance
# Unlearns WMDP bio knowledge while preserving STEM MMLU capability

export WANDB_MODE=offline
export MASTER_PORT=$((29000 + RANDOM % 1000))
export CUBLAS_WORKSPACE_CONFIG=:16:8

# Set directory for fake NVCC script
...
# Gradient difference hyperparameters
alpha=1.0              # Weight for forget loss (gradient ascent strength)
gamma=0.0              # KL regularization (0 to disable)
num_forget=5000        # Number of WMDP bio examples
num_retain=5000        # Number of MMLU STEM examples

output_dir="./runs/deep_ignorance_GradDiff_alpha${alpha}"

echo "="*60
echo "Gradient Difference Unlearning"
echo "="*60

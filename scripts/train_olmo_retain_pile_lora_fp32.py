...
Usage::
    torchrun --nproc_per_node=4 scripts/train_olmo_retain_pile_lora_fp32.py
"""
...
OUTPUT_DIR = f"runs/olmo_retain_pile_lora_fp32/{timestamp}"
...
def main():
    ...
    trainer = NoShuffleSFTTrainer(
        ...
        args=SFTConfig(
            ...
            report_to="wandb",
            run_name=f"olmo_retain_pile_lora_fp32_{timestamp}",
            save_steps=500,
            warmup_steps=50,
            weight_decay=0.01,
        ),

...
Usage::
    torchrun --nproc_per_node=4 scripts/train_olmo_forget_pile_lora.py
"""
...
OUTPUT_DIR = f"runs/olmo_forget_pile_lora/{timestamp}"
...
def main():
    ...
    trainer = NoShuffleSFTTrainer(
        ...
        args=SFTConfig(
            ...
            report_to="wandb",
            run_name=f"olmo_forget_pile_lora_{timestamp}",
            save_steps=500,
            warmup_steps=50,
            weight_decay=0.01,
        ),

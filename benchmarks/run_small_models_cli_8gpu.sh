...
for model in "${MODELS[@]}"; do
    ...
    for tokens in "${TOKEN_SCALES[@]}"; do
        ...
        echo "Updating plot..."
        python -m benchmarks.plot_cli_benchmark --run_root "runs/bergson_cli_benchmark_2" --output_csv "runs/benchmarks/small_models_8gpu.csv" --output_plot "figures/small_models_cli_benchmark.png"
    done
